...
import com.example.utility.AkkaProjectionKafkaComponents
import com.example.utility.AkkaProjectionSlickComponents
...
trait ShoppingCartComponents
    ...
    with AkkaComponents
    with AkkaProjectionSlickComponents {
  ...
  //TODO move to common trait
  reportRepository.createTable()
...
abstract class ShoppingCartApplication(context: LagomApplicationContext)
    ...
    with AkkaProjectionKafkaComponents {}
